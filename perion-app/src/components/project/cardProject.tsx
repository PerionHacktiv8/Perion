...
export function CardProject() {
    return (
        <div className="relative w-80 h-52">
            <Image src="https://static.vecteezy.com/system/resources/previews/004/965/420/non_2x/deer-in-the-forest-beautiful-sunset-scenery-illustration-free-vector.jpg" alt="Placeholder" className="w-full h-full object-cover rounded-lg" width={200} height={200}/>
